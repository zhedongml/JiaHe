...
slbConfigInfo slbConfig::GetSlbConfigInfo()
{
	...
	m_slbConfigInfo.slb_LoadDutXYZPosition.x = m_JsonControl["SLB_LoadDutXYZPosition"]["X"].get<double>();
	m_slbConfigInfo.slb_LoadDutXYZPosition.y = m_JsonControl["SLB_LoadDutXYZPosition"]["Y"].get<double>();
	m_slbConfigInfo.slb_LoadDutXYZPosition.z = m_JsonControl["SLB_LoadDutXYZPosition"]["Z"].get<double>();
